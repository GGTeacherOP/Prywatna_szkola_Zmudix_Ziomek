...
<head>
    ...
    <title>Rejestracja do Przedszkola - Akademia Wiedzy</title>
...
<body>
    ...
    <div class="container">
        <div class="left-section">
            <ul>
                <li onclick="showSection(1)"><a href="#aktualnosci"><i class="fas fa-newspaper"></i>Rejstracja przedszkole</a></li>
            </ul>
        </div>
        <div class="right-section">
            <section id="przedszkole" class="section active">
                <h2 class="section-header">Rejestracja do Przedszkola</h2>
                
                <div class="news-highlight" style="background: linear-gradient(135deg, #ffb86b, #ffa64b);">
                    <div class="highlight-content">
                        <h3>Zapisz swoje dziecko do naszego przedszkola</h3>
                        <p>Wypełnij poniższy formularz, aby zgłosić dziecko do naszego przedszkola na rok szkolny 2025/2026. Skontaktujemy się z Tobą w celu potwierdzenia rejestracji i przekazania dalszych informacji.</p>
                    </div>
                </div>
                ...
                <?php
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $email = $_POST['email'];
                        $temat = "Zapis do przedszkola na rok 2025/2026";
        ...
        <div class="footer-content">
            ...
            <div class="footer-column">
                ...
                <ul class="footer-links">
                    <li><a href="#aktualnosci" onclick="showSection(1)"><i class="fas fa-newspaper"></i>Rejstracja przedszkole</a></li>
